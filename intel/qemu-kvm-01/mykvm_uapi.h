...
/* kvm_run is just to abstrct the arch dependent vmcs
 * which contains all cpu state and the register states
 * and the exit resone
 */
struct mykvm_run {
    __u32 exit_reason;
